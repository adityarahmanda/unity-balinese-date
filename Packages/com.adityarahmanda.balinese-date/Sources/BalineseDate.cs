...
namespace BalineseCalendar
{
    public struct BalineseDate
    {
        ...
        private int GetPawukonDay(Pivot pivot, DateTime date) => GetMod(pivot.PawukonDay + GetDeltaDays(pivot.Date, date), DAY_PAWUKON);
        ...
        private PratithiSamutPada CalculatePratithiSamutPada(int[] sasihDay, SasihDayInfo sasihDayInfo, Sasih sasih, DateTime date)
        {
            var move = 0;
